...
class App(Tk):
    def __init__(self, controller):
        ...
        dimension2 = Button(self, text="2D Vector", height="3", width="15", command=lambda: [dimension2.pack_forget(), dimension3.pack_forget()])
        dimension2.pack(pady="100")

        dimension3 = Button(self, text="3D Vector", height="3", width="15", command=lambda: [dimension2.pack_forget(), dimension3.pack_forget()])
